 ...
 */
public class AttractAnchor extends AbstractActionComponentDrawer<it.units.erallab.mrsim2d.core.actions.AttractAnchor,
    Double> {
  ...
  public AttractAnchor(Color color) {
    super(it.units.erallab.mrsim2d.core.actions.AttractAnchor.class);
    this.color = color;
  }
  ...
  protected boolean innerDraw(
      double t,
      ActionOutcome<it.units.erallab.mrsim2d.core.actions.AttractAnchor, Double> o,
      Graphics2D g
  ) {
