 ...
 */
public class CreateLink extends AbstractLastingActionOutcomeDrawer<it.units.erallab.mrsim2d.core.actions.CreateLink,
    Anchor.Link> {
  ...
  public CreateLink(Color color, double duration) {
    super(it.units.erallab.mrsim2d.core.actions.CreateLink.class, duration);
    this.color = color;
  }
  ...
  protected BiPredicate<Double, Graphics2D> innerBuildTask(
      double t,
      ActionOutcome<it.units.erallab.mrsim2d.core.actions.CreateLink, Anchor.Link> o
  ) {
    return (dT, g) -> {
