 ...
 */
public class SenseVelocity extends AbstractActionComponentDrawer<it.units.erallab.mrsim2d.core.actions.SenseVelocity,
    Double> {
  ...
  public SenseVelocity(Color color) {
    super(it.units.erallab.mrsim2d.core.actions.SenseVelocity.class);
    this.color = color;
  }
  ...
  protected boolean innerDraw(
      double t,
      ActionOutcome<it.units.erallab.mrsim2d.core.actions.SenseVelocity, Double> ao,
      Graphics2D g
  ) {
    //draw line
    g.setColor(color);
