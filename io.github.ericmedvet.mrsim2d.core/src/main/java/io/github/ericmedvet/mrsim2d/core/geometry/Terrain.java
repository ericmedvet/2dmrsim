        ...
        .orElseThrow(
            () ->
                new IllegalArgumentException(
                    "Cannot find a terrain max y in range %.1f, %.1f."
                        .formatted(xRange.min(), xRange.max())));
  }

  public static Terrain fromPath(
      Path partialPath, double terrainH, double borderW, double borderH) {
    Path path =
