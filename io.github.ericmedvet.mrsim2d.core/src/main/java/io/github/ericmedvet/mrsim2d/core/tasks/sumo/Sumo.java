...
public class Sumo
    ...
    public AgentsOutcome<AgentsObservation> run(
            ...
            observations.put(
                    ...
                    new SumoObservation(List.of(
                            ...
                            new AgentsObservation.Agent(
                                    ...
                                    PolyUtils.maxYAtX(
                                            terrain.poly(),
                                            agent2.boundingBox().center().x()))), agent1Distance, agent2Distance, agent1InitialX, agent1CurrentX, agent2InitialX, agent2CurrentX));
        }
        ...
        SumoObservation finalObservation = new SumoObservation(observations.get(engine.t()).getAgents(), agent1FinalDistance, agent2FinalDistance, agent1InitialX, agent1FinalX, agent2InitialX, agent2FinalX);
