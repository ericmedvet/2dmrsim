 ...
 */
public class Voxel implements it.units.erallab.mrsim2d.core.bodies.Voxel, MultipartBody {
  ...
  private static class VoxelFilter extends BodyOwnerFilter {
    ...
    public VoxelFilter(it.units.erallab.mrsim2d.core.bodies.Body owner, BodyType bodyType) {
      super(owner);
