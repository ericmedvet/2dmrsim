...
public class LocomotionOutcomeFunctions {
  ...
  public static Function<Outcome<?>, Double> avgArea(@Param(value = "transientTime", dD = 0) double transientTime) {
  ...
  @SuppressWarnings("unused")
  public static Function<Outcome<?>, Double> xDistance(@Param(value = "transientTime", dD = 0) double transientTime) {
    return o -> o.subOutcome(new DoubleRange(transientTime, o.duration())).firstAgentXDistance();
  }

  @SuppressWarnings("unused")
  public static Function<Outcome<?>, Double> xVelocity(@Param(value = "transientTime", dD = 0) double transientTime) {
