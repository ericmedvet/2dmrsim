 ...
 */
public class SenseRotatedVelocity extends AbstractActionComponentDrawer<it.units.erallab.mrsim.core.actions.SenseRotatedVelocity,
    Double> {
  ...
  public SenseRotatedVelocity(Color color) {
    super(it.units.erallab.mrsim.core.actions.SenseRotatedVelocity.class);
    this.color = color;
  }
  ...
  protected boolean innerDraw(
      double t,
      ActionOutcome<it.units.erallab.mrsim.core.actions.SenseRotatedVelocity, Double> ao,
      Graphics2D g
  ) {
    //draw line
    g.setColor(color);
