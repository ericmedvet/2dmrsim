 ...
 */
public class SenseDistanceToBody extends AbstractActionComponentDrawer<it.units.erallab.mrsim.core.actions.SenseDistanceToBody,
    Double> {
  ...
  public SenseDistanceToBody(Color color) {
    super(it.units.erallab.mrsim.core.actions.SenseDistanceToBody.class);
    this.color = color;
  }
  ...
  protected boolean innerDraw(
      double t,
      ActionOutcome<it.units.erallab.mrsim.core.actions.SenseDistanceToBody, Double> ao,
      Graphics2D g
  ) {
    //draw line
    g.setColor(color);
